...
import { MdOutlineAddLocationAlt, MdOutlineEmail, MdPhone } from "react-icons/md";
    ...
    <>
      ...
      <section className="container-custom py-4 w-full flex flex-col gap-10 md:flex-row-reverse">
        <form onSubmit={handleSubmit(onSubmit)} className="w-full">
          <h2 className="text-gray-700 text-lg mb-3">Hubungi kami melalui form dibawah ini.</h2>
