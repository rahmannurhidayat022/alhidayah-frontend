  ...
  return (
    <>
      ...
      <section className="container-custom my-6 grid gap-6 grid-cols-1 md:grid-cols-2 md:gap-2">
        <div className="">
          <h2 className="uppercase text-lg font-semibold mb-4">Legalitas Yayasan Al-Hidayah Baitul Hatim</h2>
        ...
        <div className="">
          <h2 className="uppercase text-lg font-semibold mb-4">Profil Lembaga</h2>
