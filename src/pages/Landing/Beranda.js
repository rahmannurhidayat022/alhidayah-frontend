...
const Beranda = () => {
  ...
  const beritaRender = articles?.map(({ id, title, created_at, image }, index) => {
    return (
      <Link key={index} className="group w-full bg-white rounded overflow-hidden" to={`artikel/${id}`}>
        <div className="w-full h-[175px] overflow-hidden">
          <img className="w-full h-full bg-cover object-cover group-hover:scale-150" src={URL_STORAGE + image} alt={title} loading="lazy" />
        </div>
        <div className="p-2">
          <h3 className="font-medium text-base md:text-sm lg:text-base mb-2 group-hover:text-palette-1">{title}</h3>
  ...
  return (
    <>
      ...
      <section className="container-custom py-6 md:flex md:flex-row md:gap-8 md:flex-nowrap md:items-center md:justify-center">
        <img src="/images/about.webp" alt="tentang yayasan alhidayah baitul hatim" className="hidden md:block md:w-64 lg:w-[450px]" />
        <div className="flex flex-col md:w-[460px]">
          <h2 className="text-xl mb-4">
            <span className="font-semibold">Yayasan Al-Hidayah Baitul Hatim</span>
          </h2>
          <p className="text-[16px] mb-4">Yayasan Alhidayah-Baitul Hatim merupakan sebuah lembaga yang bergerak di bidang sosial, keagamaan dan kemanusiaan. Yang bertujuan untuk memfasilitasi anak-anak yatim piatu dan anak terlantar.</p>
          <div className="flex flex-col gap-2">
            <p className="flex gap-4 items-center">
              <span>
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.7241 31.0909C19.7513 31.0909 25.4481 25.4904 25.4481 18.5818C25.4481 11.6733 19.7513 6.07275 12.7241 6.07275C5.69675 6.07275 0 11.6733 0 18.5818C0 25.4904 5.69675 31.0909 12.7241 31.0909Z" fill="#E5EFEF" />
                  <path
                  ...
                  />
                  <path d="M8.18896 4.71301L6.01463 6.85061" stroke="#4C241D" strokeWidth="3.02737" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M6.01463 4.71301L8.18896 6.85061" stroke="#4C241D" strokeWidth="3.02737" strokeLinecap="round" strokeLinejoin="round" />
                  <path
              ...
              Saling mendoakan antara sesama dengan penuh cinta
            </p>
            <div className="flex gap-4 items-center">
              <span>
                <svg width="39" height="36" viewBox="0 0 39 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="#E5EFEF"
                  />
                  <path d="M4.2069 2V3.12281" stroke="#4C241D" strokeWidth="2.97517" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M4.2069 5.36853V6.49134" stroke="#4C241D" strokeWidth="2.97517" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M2 4.24561H3.10345" stroke="#4C241D" strokeWidth="2.97517" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M5.31034 4.24561H6.41379" stroke="#4C241D" strokeWidth="2.97517" strokeLinecap="round" strokeLinejoin="round" />
                  <path
              ...
              Peduli, Melayani dengan tulus kasih sayang terhadapa sesama
            </div>
          </div>
        </div>
      </section>
