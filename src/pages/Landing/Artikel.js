          ...
          <article className="w-full overflow-x-hidden">
            ...
            <div className="leading-relaxed break-words">
              ...
              <div className="inline group">
                <p
                  className="h-20 overflow-y-hidden font-medium text-[16px] group-hover:text-blue-900"
  ...
  return (
    <>
      ...
      <div className="my-8 flex justify-center">
        <SearchForm label="Cari artikel lainnya:" action={getArticles} />
      </div>
      ...
      <section className="container-custom flex flex-col justify-center items-center">
        {pagination.totalPage > 1 && (
          <Pagination data={pagination} hadler={getArticles} />
        )}
      </section>
    </>
  );
