...
import { changeReadStatus, deleteContactById, getAllContact, sendMail } from "../actions/contact-action";
...
const contactSlice = createSlice({
    ...
    extraReducers: {
        ...
        [sendMail.fulfilled]: (state) => {
            state.loading = false;
            state.success = "Pesan terkirim. Kami akan menghubungi anda melalui E-Mail yang tercantum.";
        },
