...
export const getAllDebit = createAsyncThunk(
    "debit/getAllDebit",
...
export const getDebitById = createAsyncThunk(
    "debit/getDebitById",
...
export const updateDebit = createAsyncThunk(
    "debit/updateDebit",
    async (
        { id, nomor_rekening, nama_bank, atas_nama },
        { getState, rejectWithValue }
    ) => {
        try {
            const { user } = getState();
...
export const deleteDebitById = createAsyncThunk(
    "debit/deleteDebitById",
