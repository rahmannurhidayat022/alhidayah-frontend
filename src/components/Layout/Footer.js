  ...
  return (
    <footer className="flex-col h-full mt-10 pt-10 bg-palette-4 text-white">
      <div className="container-custom">
        <div className="block md:flex justify-center">
          <div className="flex flex-col py-4 border-b-2 md:w-96 md:mr-10 border-gray-200/20 md:border-0">
            ...
            <p className="pl-1">Jl. Trs. St. Kiaracondong, RT.02/RW.08, Kebun Jayanti, Kec. Kiaracondong, Kota Bandung, Jawa Barat 40281</p>
          </div>
      ...
      <div className="bg-[#454F5B]">
        <div className="container-custom text-center py-4">© 2022 Yayasan Al-Hidayah Baitul Hatim. All Rights Reserved.</div>
      </div>
    </footer>
  );
};
